...
public class ControladorOpcionInstructivoEventHandler implements EventHandler<ActionEvent> {
	...
	public void handle(ActionEvent arg0) {
        ...
        String mensaje = "Convencion para la superficie segun el color de los casilleros:\n"
        		+ "Color Gris: Superficie Roca no afecta en ningun estado\n"
        		...
        		+ "Misil: Doble Canion - Duplica su danio 3 turnos\n"
        		+ "Floppy: Flash - Triplica su velocidad por 3 turnos\n"
        		+ "VGA: Burbuja inmaculada - No recibe danio por 2 turnos\n"
        		+ "\n";
